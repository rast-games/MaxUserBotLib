...
class Backoff:
    def __init__(self, config: BackoffConfig) -> None:
        ...
        :param config: BackoffConfig instance to process.
        :type config: BackoffConfig
        """
        self.config = config
    ...
    def __iter__(self) -> "Backoff":
        ...
        :returns: The resulting 'Backoff' value.
        :rtype: 'Backoff'
        """
        return self
    ...
    def __next__(self) -> float:
        ...
        :returns: The resulting float value.
        :rtype: float
        :raises BackoffError: If the requested action cannot be completed.
        """
